module ExpensesHelper
  ...
  def get_expenses_number_by_month(month)
  ...
  def get_expenses_number_by_year(year)
  ...
  def get_average_daily_expenses(start_date=nil, end_date=nil)
    ...
    (get_expenses_number(start_date, end_date)/days(nil, start_date, end_date)).round(2)
  end
